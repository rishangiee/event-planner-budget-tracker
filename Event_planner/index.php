...
// Format date and time
            ...
            <article class="event-card">
                <div class="event-img">
                    ...
                    <?php else: ?>
                    <div class="img-bg" style="background: linear-gradient(135deg, <?php echo $badgeColor; ?>40, <?php echo $badgeColor; ?>20);"></div>
                    <?php endif; ?>
...
<div class="event-actions" style="display: flex; gap: 10px; margin-top: 18px;">
                        <button type="button" class="btn-view-details" onclick="showEventDetails('<?php echo htmlspecialchars($event['id']); ?>', '<?php echo htmlspecialchars($event['title']); ?>', '<?php echo $eventDate; ?>', '<?php echo $eventTime; ?>', '<?php echo $location; ?>', '<?php echo $description; ?>', '<?php echo $budget; ?>', '<?php echo $maxAttendees; ?>')" style="flex: 1; padding: 10px 16px; background: transparent; border: 1.5px solid var(--sage); color: var(--sage); border-radius: 20px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.3s ease;">
                            View Details
                        </button>
<button type="button" class="btn- book- now" onclick="openBookingForm('<?php echo htmlspecialchars($event['id']); ?>', '<?php echo $eventDate; ?>', '<?php echo $budget; ?>', <?php echo $maxAttendees; ?>)" style="flex: 1; padding: 10px 16px; background: var(--sage); border: none; color: white; border-radius: 20px; font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.3s ease;">
                            Book Now
                        </button>
                    </div>
                </div>
