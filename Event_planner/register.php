    ...
    if ($password !== $confirm_password) {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            if ($stmt->execute([$email, $name, $lastname, $firstname, $middlename ?: null, $suffix ?: null, $address, $contact_number, $hashedPassword])) {
                ...
                // Check for pending booking in sessionStorage (passed via hidden field)
                ...
                // Check if we have a pending booking to process
                if (isset($_SESSION['pending_booking'])) {
                    ...
                    try {
                        ...
                        // Log error, continue with registration
                    }
...
$success = 'Registration successful!';
                ...
                // If there's a pending booking, process it and redirect to dashboard
...
<script>
    // Check for pending booking in sessionStorage on page load
